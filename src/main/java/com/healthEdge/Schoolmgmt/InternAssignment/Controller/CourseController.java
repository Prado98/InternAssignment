...
public class CourseController {
    ...
    public Course GetCourseByCredit(@PathVariable("courseCredit") int courseCredit){
    ...
    public void InsertCourse(@RequestBody Course courseDao)
    {
        this.courseDao.insertCourse(courseCredit);
    }
